...
API.onResourceStart.connect(function() {
	...
	fillHairMenu();
	// CLOTHES
	creatorClothesMenu = API.addSubMenu(creatorMainMenu, "Clothes", "Your character's clothes.", 0, 0, 6);
	...
	clothes_top_Item = API.createListItem("Top", "", clothes_top_list, 0);
	creatorClothesMenu.AddItem(clothes_top_Item);

	// CLOTHES - TOP - COLOR
	var clothes_top_color_list = new List(String);
	for (var i = 0; i < 6; i++) clothes_top_color_list.Add(i.toString());
	clothes_top_color_Item = API.createListItem("Top Color", "", clothes_top_color_list, 0);
	...
	clothes_legs_Item = API.createListItem("Legs", "", clothes_legs_list, 0);
	creatorClothesMenu.AddItem(clothes_legs_Item);

	// CLOTHES - LEGS - COLOR
	var clothes_legs_color_list = new List(String);
	for (var i = 0; i < 6; i++) clothes_legs_color_list.Add(i.toString());
	clothes_legs_color_Item = API.createListItem("Legs Color", "", clothes_legs_color_list, 0);
	...
	clothes_feet_Item = API.createListItem("Shoes", "", clothes_feet_list, 0);
	...
	// SAVE & CANCEL BUTTONS
	var save_button = API.createColoredItem("Save", "Save all changes and leave the character creator.\n\nIf you save, you will never be able to change the appearance of your character.", "#0d47a1", "#1976d2");
